...
export const SKILL_MODEL_VARS = {
  OPUS_ID: 'claudechip-opus-4-6',
  OPUS_NAME: 'ClaudeChip Opus 4.6',
  SONNET_ID: 'claudechip-sonnet-4-6',
  SONNET_NAME: 'ClaudeChip Sonnet 4.6',
  HAIKU_ID: 'claudechip-haiku-4-5',
  HAIKU_NAME: 'ClaudeChip Haiku 4.5',
  // Previous Sonnet ID — used in "do not append date suffixes" example in SKILL.md.
  PREV_SONNET_ID: 'claudechip-sonnet-4-5',

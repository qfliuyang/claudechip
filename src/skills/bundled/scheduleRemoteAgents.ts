...
4. **Choose the model** — Default to \`claudechip-sonnet-4-6\`. Tell the user which model you're defaulting to and ask if they want a different one.

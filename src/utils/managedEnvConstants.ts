...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'CLAUDECHIP_MODEL',
  'CLAUDECHIP_DEFAULT_HAIKU_MODEL',
  'CLAUDECHIP_DEFAULT_HAIKU_MODEL_DESCRIPTION',
  'CLAUDECHIP_DEFAULT_HAIKU_MODEL_NAME',
  'CLAUDECHIP_DEFAULT_HAIKU_MODEL_SUPPORTED_CAPABILITIES',
  'CLAUDECHIP_DEFAULT_OPUS_MODEL',
  'CLAUDECHIP_DEFAULT_OPUS_MODEL_DESCRIPTION',
  'CLAUDECHIP_DEFAULT_OPUS_MODEL_NAME',
  'CLAUDECHIP_DEFAULT_OPUS_MODEL_SUPPORTED_CAPABILITIES',
  'CLAUDECHIP_DEFAULT_SONNET_MODEL',
  'CLAUDECHIP_DEFAULT_SONNET_MODEL_DESCRIPTION',
  'CLAUDECHIP_DEFAULT_SONNET_MODEL_NAME',
  'CLAUDECHIP_DEFAULT_SONNET_MODEL_SUPPORTED_CAPABILITIES',
  'CLAUDECHIP_SMALL_FAST_MODEL',
  'CLAUDECHIP_SMALL_FAST_MODEL_AWS_REGION',
 ...
 * - CLAUDECHIP_BASE_URL, ANTHROPIC_BEDROCK_BASE_URL, ANTHROPIC_FOUNDRY_BASE_URL, ANTHROPIC_VERTEX_BASE_URL
 ...
 * - ANTHROPIC_FOUNDRY_RESOURCE
 * - CLAUDECHIP_API_KEY, ANTHROPIC_AUTH_TOKEN
 * - AWS_BEARER_TOKEN_BEDROCK
 */
export const SAFE_ENV_VARS = new Set([
  ...
  'USE_BUILTIN_RIPGREP',
  'VERTEX_REGION_CLAUDECHIP_3_5_HAIKU',
  'VERTEX_REGION_CLAUDECHIP_3_5_SONNET',
  'VERTEX_REGION_CLAUDECHIP_3_7_SONNET',
  'VERTEX_REGION_CLAUDECHIP_4_0_OPUS',
  'VERTEX_REGION_CLAUDECHIP_4_0_SONNET',
  'VERTEX_REGION_CLAUDECHIP_4_1_OPUS',
  'VERTEX_REGION_CLAUDECHIP_4_5_SONNET',
  'VERTEX_REGION_CLAUDECHIP_4_6_SONNET',
  'VERTEX_REGION_CLAUDECHIP_HAIKU_4_5',
])
